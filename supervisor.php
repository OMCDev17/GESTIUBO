...
<title>Supervisor - Lab Portal</title>
...
<h2 class="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-[-0.015em] border-l border-slate-300 dark:border-slate-700 pl-4">Supervisor / Group Manager</h2>
<?php if ($fullName): ?>
...
<span class="inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 py-1 text-primary font-semibold"><?php echo htmlspecialchars(trim($user['grupo'] ?? '')); ?></span>
</div>
</div>
